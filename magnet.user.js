...
// @match http://*/*
// @match https://*/*
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?10\.\d{1,3}\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.16\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.17\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.18\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.19\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.20\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.21\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.22\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.23\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.24\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.25\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.26\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.27\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.28\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.29\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.30\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?172\.31\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?192\.168\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude /^[^:/#?]*:\/\/([^#?/]*\.)?127\.\d{1,3}\.\d{1,3}\.\d{1,3}(:[0-9]{1,5})?\/.*$/
// @exclude *://localhost/*
// @exclude *://*.local/*
// @exclude *://*.internal/*
// @exclude *://*.lan/*
...
(function() {
    ...
    // qbittorrent 淡蓝色 (Light Sky Blue) RGB: 135, 206, 250,  RGBA: rgba(135, 206, 250, 0.8) 透明度 80%
    var qb_lightblue_rgba = 'rgba(135, 206, 250, 0.8)';
    // transmission 灰色 (Light Gray) RGB: 211, 211, 211, RGBA: rgba(211, 211, 211, 0.9) 透明度 90%  <---  修改为 90% 透明度
    var trans_gray_rgba = 'rgba(211, 211, 211, 0.9)';
    ...
    function getmag() {
        ...
        divObj.style.background = trans_gray_rgba; //  <----  弹出背景颜色改为 transmission 灰色
            ...
            if (links && links.length > 0) { // 确保 links 存在且有内容
                ...
                magnetLinks.forEach(magnet => {
                    magnetListHTML += `<div style='margin-bottom: 5px; display: flex; align-items: center; justify-content: space-between;'>
                                         <span style='word-wrap: break-word; word-break: break-all; margin-right: 10px; color: #000; font-size: 1.2em;'>${magnet}</span>  <!-- 磁力链接文字颜色保持黑色，字体大小增加 20% -->
                ...
                document.getElementById("showmagnet").innerHTML = "<div style='padding: 20px; color: #333;'>没有找到磁力链</div>"; // 没有找到磁力链提示文字颜色保持深灰色
                document.getElementById("magbtn").innerHTML = nrstr;
            }
